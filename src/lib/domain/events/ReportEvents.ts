...
export class ReportGeneratedEvent implements DomainEvent {
  ...
  readonly eventType: string = EVENT_TYPES.REPORT_GENERATED;
  readonly aggregateId: string;
  readonly aggregateType: string = 'Report';
  ...
  static create(reportType: string, period: string): ReportGeneratedEvent {
    return new ReportGeneratedEvent(_nextId(), reportType, Timestamp.now().toISO(), { reportType: reportType, period: period });
  }
}
