...
async function runMigration() {
  console.log('🚀 Starting Market Intelligence Platform v2 database migration...\n');

  const migrationFilePath = path.join(__dirname, '../../supabase/migrations/00000000000026_market_intelligence_schema_v2.sql');
