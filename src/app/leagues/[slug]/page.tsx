...
export async function generateMetadata({ params }: PageProps) {
  ...
  if (!league) {
    return {
      title: 'League Not Found | HandicapLab',
    };
  }
  ...
  return {
    ...
    alternates: {
      canonical: `https://handicap-lab.vercel.app/leagues/${slug}`,
    },
    openGraph: {
      ...
      url: `https://handicap-lab.vercel.app/leagues/${slug}`,
      type: 'website',
    }
  };
}
...
export default async function LeaguePage({ params }: PageProps) {
  ...
  const breadcrumbs = [
    ...
    { name: league.name, item: `https://handicap-lab.vercel.app/leagues/${slug}` }
  ];
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 py-12 px-6">
      ...
      <main className="max-w-5xl mx-auto space-y-12">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="text-xs font-mono text-emerald-400 uppercase tracking-widest">{league.country}</span>
        ...
        <div className="space-y-6 pt-6 border-t border-slate-850">
          <h3 className="text-lg font-bold text-white font-mono">League Predictive Intelligence FAQ</h3>
